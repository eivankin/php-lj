 ...
 * Содержит информацию о пользователе, список недавних публикаций и кнопки для
 * управления подпиской на этого пользователя.
 *
 * При попытке просмотреть информацию о самом себе произойдёт перенаправление в личный кабинет.
 */
