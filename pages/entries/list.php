<?php
/**
 * Страница списка публикаций.
 * Поддерживается сортировка и фильтрация публикаций.
 *
 * В таблице публикаций указаны заголовок, ссылка на автора, категория, дата публикации и редактирования, список тегов,
 * количество просмотров и доступные для пользователя действия над публикацией.
 */
